			...
			<div class="w3ls_mobiles_grids">
				<div class="w3ls_mobiles_grid_right_grid2">
						<section class="webdesigntuts-workshop">
							<form action="Busqueda_mercado.php" method="get" >		    
								<input type="search" name="busqueda" id="busqueda" placeholder="Descripción" value="<?php echo $busqueda; ?>">		    	
								<button> <i class="fas fa-search"></i></button>
							</form>
						</section>						
					<div class="clearfix"> </div>
				</div>
				<?php include "includes/filtrocat.php"; ?>			
